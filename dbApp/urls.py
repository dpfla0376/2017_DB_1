...
urlpatterns = [
    ...
    url(r'^resource/service/(?P<pk>[\d]+)/addsan/(?P<manage_num>[\w]+)/$', views.service_detail, name='service_add_san'),
    url(r'^resource/service/(?P<pk>[\d]+)/addnas/$', views.service_detail, name='service_add_nas'),
    url(r'^resource/service/(?P<pk>[\d]+)/addnas/(?P<manage_num>[\w]+)/$', views.service_detail, name='service_add_nas'),
